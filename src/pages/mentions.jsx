...
import "../styles/mentions/mentions.css";
  ...
  return (
    <body id="mentions">
      <div className="container-mentions">
        <img className="mentions-logo" src={teacherrLogo} />
      </div>
      <div className="container-mentions">
        <h2>Définitions</h2>
        <p>
          ...
          <a href="https://www.teacherr.fr">https://www.teacherr.fr</a> met à
        ...
        <p>
          ...
          d’être détenues par{" "}
          <a href="https://www.teacherr.fr">https://www.teacherr.fr</a> pour la
      ...
      <div className="container-mentions">
        ...
        <p>
          ...
          du site internet{" "}
          <a href="https://www.teacherr.fr">https://www.teacherr.fr</a>{" "}
          l'identité des différents intervenants dans le cadre de sa réalisation
          et de son suivi:
        </p>
        <p>
          <strong>Propriétaire</strong> : Samuel Joséphine – 8 Boulevard Louis
          XIV 59000 LILLE
          <br />
          <strong>Responsable publication</strong> : Samuel – feur.feur@feur.fr
          <br />
          Le responsable publication est une personne physique ou une personne
          morale.
          <br />
          <strong>Webmaster</strong> : Samuel – feur.feur@feur.fr
          <br />
          <strong>Hébergeur</strong> : localhost – 8 Boulevard Louis XIV 59000
          LILLE 0698123456
          <br />
          <strong>Délégué à la protection des données</strong> : Sam –
          feur.feur@feur.fr
          <br />
        </p>
      ...
      <div className="container-mentions">
        ...
        <p>
          ...
          <a href="https://www.teacherr.fr">https://www.teacherr.fr</a> implique
          ...
          <a href="https://www.teacherr.fr">https://www.teacherr.fr</a> sont
        ...
        <p>
          ...
          <a href="https://www.teacherr.fr">https://www.teacherr.fr</a>, qui
          s’efforcera alors de communiquer préalablement aux utilisateurs les
          dates et heures de l’intervention. Le site web{" "}
          <a href="https://www.teacherr.fr">https://www.teacherr.fr</a> est mis
          à jour régulièrement par{" "}
          <a href="https://www.teacherr.fr">https://www.teacherr.fr</a>{" "}
      ...
      <div className="container-mentions">
        ...
        <p>
          Le site internet{" "}
          <a href="https://www.teacherr.fr">https://www.teacherr.fr</a> a pour
          objet de fournir une information concernant l’ensemble des activités
          de la société.
          <a href="https://www.teacherr.fr">https://www.teacherr.fr</a>{" "}
          s’efforce de fournir sur le site{" "}
          <a href="https://www.teacherr.fr">https://www.teacherr.fr</a> des
        ...
        <p>
          ...
          <a href="https://www.teacherr.fr">https://www.teacherr.fr</a> ne sont
      ...
      <div className="container-mentions">
        ...
        <p>
          ...
          <a href="https://www.teacherr.fr">https://www.teacherr.fr</a> est
        ...
        <p>
          <a href="https://www.teacherr.fr">https://www.teacherr.fr</a> et
      ...
      <div className="container-mentions">
        ...
        <p>
          <a href="https://www.teacherr.fr">https://www.teacherr.fr</a> agit en
          tant qu’éditeur du site.{" "}
          <a href="https://www.teacherr.fr">https://www.teacherr.fr</a> est
          responsable de la qualité et de la véracité du Contenu qu’il publie.{" "}
        </p>
        <p>
          <a href="https://www.teacherr.fr">https://www.teacherr.fr</a> ne
          pourra être tenu responsable des dommages directs et indirects causés
        ...
        <p>
          ...
          <a href="https://www.teacherr.fr">https://www.teacherr.fr</a> se
      ...
      <div className="container-mentions">
        ...
        <p>
          ...
          le responsable du traitement des Données Personnelles est : Samuel
          Joséphine.{" "}
          <a href="https://www.teacherr.fr">https://www.teacherr.fr</a>
          est représenté par Samuel, son représentant légal
        </p>
        <p>
          En tant que responsable du traitement des données qu’il collecte,{" "}
          <a href="https://www.teacherr.fr">https://www.teacherr.fr</a> s’engage
          ...
          <a href="https://www.teacherr.fr">https://www.teacherr.fr</a> traite
          des Données Personnelles,{" "}
          <a href="https://www.teacherr.fr">https://www.teacherr.fr</a> prend
          ...
          lesquelles{" "}
          <a href="https://www.teacherr.fr">https://www.teacherr.fr</a> les
          traite.
        </p>
      </div>
      <div className="container-mentions">
      ...
      <div className="container-mentions">
        ...
        <ul>
          ...
          <li>
            ...
            <a href="https://www.teacherr.fr">https://www.teacherr.fr</a> devra
            communiquer (ou non) ses données à un tiers qu’ils aura
            préalablement désigné
          </li>
        </ul>
        <p>
          Dès que <a href="https://www.teacherr.fr">https://www.teacherr.fr</a>{" "}
          a connaissance du décès d’un Utilisateur et à défaut d’instructions de
          sa part, <a href="https://www.teacherr.fr">https://www.teacherr.fr</a>{" "}
        ...
        <p>
          ...
          <a href="https://www.teacherr.fr">https://www.teacherr.fr</a> utilise
          ses Données Personnelles, demander à les rectifier ou s’oppose à leur
          traitement, l’Utilisateur peut contacter{" "}
          <a href="https://www.teacherr.fr">https://www.teacherr.fr</a> par
          écrit à l’adresse suivante :{" "}
        </p>
        Samuel Joséphine – DPO, Sam <br />8 Boulevard Louis XIV 59000 LILLE.
        <p>
          Dans ce cas, l’Utilisateur doit indiquer les Données Personnelles
          qu’il souhaiterait que{" "}
          <a href="https://www.teacherr.fr">https://www.teacherr.fr</a> corrige,
        ...
        <p>
          ...
          <a href="https://www.teacherr.fr">https://www.teacherr.fr</a> par la
          loi, notamment en matière de conservation ou d’archivage des
          documents. Enfin, les Utilisateurs de{" "}
          <a href="https://www.teacherr.fr">https://www.teacherr.fr</a> peuvent
          déposer une réclamation auprès des autorités de contrôle, et notamment
      ...
      <div className="container-mentions">
        ...
        <p>
          ...
          <a href="https://www.teacherr.fr">https://www.teacherr.fr</a> reste
        ...
        <p>
          ...
          des filiales de{" "}
          <a href="https://www.teacherr.fr">https://www.teacherr.fr</a> et des
      ...
      <div className="container-mentions">
        ...
        <p>
          ...
          <a href="https://www.teacherr.fr">https://www.teacherr.fr</a> n'est
          ...
          rachat de{" "}
          <a href="https://www.teacherr.fr">https://www.teacherr.fr</a> et de
      ...
      <div className="container-mentions">
        ...
        <p>
          Le site <a href="https://www.teacherr.fr">https://www.teacherr.fr</a>{" "}
          contient un certain nombre de liens hypertextes vers d’autres sites,
          mis en place avec l’autorisation de{" "}
          <a href="https://www.teacherr.fr">https://www.teacherr.fr</a>.
          Cependant,{" "}
          <a href="https://www.teacherr.fr">https://www.teacherr.fr</a> n’a pas
      ...
      <div className="container-mentions">
        ...
        <p>
          ...
          <a href="https://www.teacherr.fr">https://www.teacherr.fr</a> informe
        ...
        <p>
          ...
          être le cas lorsque{" "}
          <a href="https://www.teacherr.fr">https://www.teacherr.fr</a> ou l’un
        ...
        <p>
          Le cas échéant,{" "}
          <a href="https://www.teacherr.fr">https://www.teacherr.fr</a> décline
        ...
        <p>
          ...
          <a href="https://www.teacherr.fr">https://www.teacherr.fr</a> pourra
        ...
        <p>
          ...
          <a href="https://www.teacherr.fr">https://www.teacherr.fr</a> ou dans
        ...
        <p>
          ...
          <a href="https://www.teacherr.fr">https://www.teacherr.fr</a>. À tout
          moment, l’Utilisateur peut néanmoins revenir sur son consentement à ce
          que <a href="https://www.teacherr.fr">https://www.teacherr.fr</a>{" "}
      ...
      <div className="container-mentions">
        ...
        <p>
          <a href="https://www.teacherr.fr">https://www.teacherr.fr</a> peut
          ...
          IP de l’Utilisateur) dans un pays étranger.
        </p>
        <p>
