      ...
      <div className="contenu">
        ...
        <div className="container-mentions">
          ...
          <p>
            ...
            d’être détenues par{" "}
            <a href="https://www.teacherr.fr">https://www.teacherr.fr</a> pour
            la gestion de votre compte, de la gestion de la relation client et à
        ...
        <div className="container-mentions">
          ...
          <p>
            ...
            XIV 59000 LILLE
            <br />
            <strong>Responsable publication</strong> : Samuel –
            feur.feur@feur.fr
            <br />
        ...
        <div className="container-mentions">
          ...
          <p>
            ...
            site <a href="https://www.teacherr.fr">https://www.teacherr.fr</a>{" "}
        ...
        <div className="container-mentions">
          ...
          <p>
            <a href="https://www.teacherr.fr">https://www.teacherr.fr</a> agit
        ...
        <div className="container-mentions">
          ...
          <p>
            Dès que{" "}
            <a href="https://www.teacherr.fr">https://www.teacherr.fr</a> a
        ...
        <div className="container-mentions">
          ...
          <p>
            ...
            <a href="https://www.teacherr.fr">https://www.teacherr.fr</a>.
            Cependant,{" "}
            <a href="https://www.teacherr.fr">https://www.teacherr.fr</a> n’a
            pas la possibilité de vérifier le contenu des sites ainsi visités,
        ...
        <div className="container-mentions">
          ...
          <p>
            ...
            <a href="https://www.teacherr.fr">https://www.teacherr.fr</a> ou
          ...
          <p>
            ...
            <a href="https://www.teacherr.fr">https://www.teacherr.fr</a> ou
            dans son application mobile et si l’Utilisateur a accepté le dépôt
          ...
          <p>
            ...
            <a href="https://www.teacherr.fr">https://www.teacherr.fr</a>. À
            tout moment, l’Utilisateur peut néanmoins revenir sur son
            consentement à ce que{" "}
            <a href="https://www.teacherr.fr">https://www.teacherr.fr</a> dépose
            ce type de cookies.
          </p>
        </div>
        <div className="container-mentions">
